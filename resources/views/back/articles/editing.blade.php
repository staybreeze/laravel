      ...
      <main class="col-md-9 ms-sm-auto col-lg-10 px-md-4">
        ...
        <div class="container-fluid mt-3 ">
          ...
          <a href="{{ url('/back/articles/create?do=articles&create') }}">
            ...
            @if(strpos($do, 'edit') !== false)
            <a href="{{ url('/back/articles/edit?do=articles&edit') }}">
              <h4 class="mt-5 color-blue ms-4 mb-4">編輯中</h4>
            </a>
            @else
            <a href="{{ url('/back/articles/edit?do=articles&edit') }}">
              <h4 class="mt-5 color-gray ms-4 mb-4">編輯中</h4>
            </a>
            @endif
          </div>
          <div class="dotted-border ms-95">
          <form action="{{ route('article.update', ['id' => $article['id'], 'page' => $page]) }}" method="post" class="mt-4" enctype="multipart/form-data">
          @csrf
          <h4 class="color-brown ms-95">標題</h4>
              <input type="text" name="title" value="{{ trim($article['title']) }}" class="ms-95" style="width:50%">
              ...
              <div class="d-flex mt-5">
                ...
                <img src="{{ asset($article['img']) }}" class="ms-95 mb-5" width="300px">
                <input type="hidden" name="originImg" value="{{ $article['img'] }}">

                <h4 class="mt-5 ms-95 color-brown">選擇新圖片<p style="color:brown;font-size:small;margin-top:5px">{{ __('general.img_file_size_limit') }}</p></h4>
                <input type="file" name="img" class="mt-5 ms-95 mb-4">
