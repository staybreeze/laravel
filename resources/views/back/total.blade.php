...
@include('partials.back_nav')
      <main class="col-md-9 ms-sm-auto col-lg-10 px-md-4">
        ...
        <div class="container-fluid mt-3">
          ...
          <form method="post" action="{{ route('back.edit.total') }}" style="margin-left:95px">
            @csrf
            <table style="width:30%">
              ...
              <tr class="th-update">
                ...
                <td width="50%">
                <input type="number" name="total" value="{{$appPresenter->getTotalValue()}}" style="text-align:center">
              </tr>
            </table>
            <table>
              <tr>
