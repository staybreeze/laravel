    ...
    <div class="row d-flex main">
      ...
      <div class="col-6 section ms-5 ps-5">
        ...
        <div class="box mt-5 text-center">
          ...
          <form action="{{ route('logging') }}" method="post" class=" col-12 col-sm-4 m-auto">
            @csrf
            ...
            <div>
              <a href="{{ route('register.index') }}" class="add" style="padding-left:200px;text-decoration:underline;color:cadetblue"><i class="fa-solid fa-user-plus mt-1"></i>&nbsp;加入會員</a>
            </div>
