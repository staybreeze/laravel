              ...
              <div class="col-12">
                <div class="mb-3">
                  ...
                  <input type="password" class="form-control" id="pw" placeholder="Enter password" name="pw">
                          ...
                          <a href="{{ route('register.index') }}" style="padding-left:0px;text-decoration:underline;color:cadetblue" class="ms-3 mt-2"><i class="fa-solid mb-1 fa-user-plus"></i>&nbsp;加入會員</a>
                </div>
            </div>
            <div style="display:flex" class="mt-3  ms-2"> <?php

                                                    $_SESSION['ans'] = $appPresenter->code(5);
                                                    $img = $appPresenter->captcha($_SESSION['ans']);
                                                    ?>
              <img src="<?= $img; ?>">
