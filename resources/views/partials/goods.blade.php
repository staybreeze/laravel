            ...
            <div class="col-md-6 col-lg-4 col-xl-3">
                <div id="product{{ $good['id'] }}" class="single-product">
                    <div class="part-1">
                        ...
                        <br><br>
                        <div>
                            <i class="fa-sharp fa-solid fa-boxes-stacked" style="font-size:smaller">
                                <span style="font-size:smaller">&nbsp;&nbsp;&nbsp;{{ $good['remain'] }}</span>
                            </i>
                        </div>
                        ...
                        <ul>
                            ...
                            <li>
                                ...
                                <a href="{{ route('add.good', ['id' => $good['id']]) }}" class="plus-atag">
                            ...
                            <li>
                                <a style="cursor:pointer" class="goodImgExpand">
                                    <i class="fas fa-expand" data-img="{{ $good['img'] }}"></i>
                                </a>
                            </li>
                        </ul>
                    </div>
