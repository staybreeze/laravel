    ...
    <head>
      <title>Sed ipsam perferendis occaecati rerum et ipsum facilis.</title>
...
<div class="container-fluid">
  <div class="row d-flex main">
    ...
    <img src="{{ asset('img/1721576013.jpg') }}" width="100%" style="padding-top:70px">
    </div>
    <div class="col-6 section ms-5 ps-5">
      <br>
      <div class="box mt-5">
        <h3 class="h3">&nbsp; Sed ipsam perferendis occaecati rerum et ipsum facilis.</h3>
        <p class="mt-5" id="origin">
        Voluptatem autem aut cupiditate quaerat et ducimus. Dignissimos saepe voluptates tempora minima asperiores rerum. Delectus ut cum beatae qui consectetur aliquid consequuntur. Vitae repellat pariatur repellat.
         </p> <br>
      </div>
      <div class="col-1"></div>
    </div>
