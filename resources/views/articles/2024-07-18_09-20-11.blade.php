    ...
    <head>
      <title>Ad deleniti quisquam ad quia hic.</title>
...
margin-left: 227px !important;
    ...
    <body>
    @include('partials.header_article')
    @include('partials.mouse_squares')
<div class="container-fluid">
  <div class="row d-flex main">
    <div class="col-5 aside">
    <img src="{{ asset(https://via.placeholder.com/640x480.png/007766?text=et) }}" width="100%" style="padding-top:70px">
    </div>
    <div class="col-6 section ms-5 ps-5">
      <br>
      <div class="box mt-5">
        <h3 class="h3">&nbsp; Ad deleniti quisquam ad quia hic.</h3>
        <p class="mt-5" id="origin">
        Corrupti voluptas assumenda rem saepe eius omnis id. Porro ut magnam quaerat. Corporis earum qui occaecati voluptas consequatur.
         </p> <br>
      </div>
      <div class="col-1"></div>
    </div>
...
@include('inc.login_article')
@include('inc.footer_article')
</body>
