    ...
    <head>
      <title>Quaerat eos sunt non ex possimus sint.</title>
...
<div class="container-fluid">
  <div class="row d-flex main">
    ...
    <img src="{{ asset(https://via.placeholder.com/640x480.png/00cc33?text=id) }}" width="100%" style="padding-top:70px">
    </div>
    <div class="col-6 section ms-5 ps-5">
      <br>
      <div class="box mt-5">
        <h3 class="h3">&nbsp; Quaerat eos sunt non ex possimus sint.</h3>
        <p class="mt-5" id="origin">
        Quaerat et excepturi ab dicta. Beatae ut tenetur iste eius quia. Corporis eos qui numquam consequatur et voluptate.
         </p> <br>
      </div>
      <div class="col-1"></div>
    </div>
